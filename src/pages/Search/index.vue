    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <!-- 分类的面包屑 -->
            <li class="with-x" v-if="searchParams.categoryName" @click="removeCategoryName">{{searchParams.categoryName}}<i>×</i></li>
            <!-- 关键字的面包屑 -->
            ...
            <!--平台的售卖的属性值展示 -->
            <li class="with-x" v-for="(attrValue,index) in searchParams.props" :key="index" @click="removeAttrValue(index)">{{attrValue.split(':')[1]}}<i>×</i></li>
          </ul>
        </div>
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                ...
                <li :class="{active: isTwo}" @click="changeOrder('2')">
                  <a><span v-show="isTwo" class="iconfont" :class="{'icon-UP': isAsc,'icon-DOWN': isDesc}"></span>销量</a>
                </li>
              </ul>
            </div>
          </div>
